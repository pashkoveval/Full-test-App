<template>
  <div class="header">
    <div class="nav">
      ...
      <div class="right">
        <button class="burger" @click="(menu = !menu), bodyStop()">
          <svg
            width="32"
            height="23"
            viewBox="0 0 32 23"
        ...
        <router-link class="cart" to="cart">
          ...
          <div v-if="CART.length" class="cart-quantity">
            <span>{{ quantityOFItemInCart }}</span>
          </div>
        </router-link>
        <div class="menu" v-if="menu">
          <button class="menu-close" @click="(menu = !menu), bodyStop()">
            <svg
              width="13"
              height="13"
              viewBox="0 0 13 13"
          ...
          animi! Voluptate laboriosam numquam illum assumenda earum similique
          aliquam nobis vitae ut voluptates itaque minima, mollitia iure velit,
          quis cupiditate.
        </div>
        <div
          class="masc-all"
          v-if="menu"
          @click="(menu = !menu), bodyStop()"
        ></div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions(["GET_SERACH_VALUE_TO_VUEX", "GET_GOODS_FROM_API_CART"]),
    search(value) {
      this.GET_SERACH_VALUE_TO_VUEX(value);
    },
    bodyStop() {
      if (this.menu) {
