<template>
  <div class="catalog-item">
    <div class="catalog-item-ferst__block">
      <img src="img/item1.png" alt="" /><img
        class="catalog-item-img"
        :src="item.img"
        alt="img"
      />
      <div class="catalog-item-ferst__block-mask">
...
.catalog-item {
  ...
  margin: 15px;
  &:hover {
    & .catalog-item-ferst__block-mask {
      visibility: visible;
      opacity: 1;
    }
  }
  ...
  &-ferst__block {
    ...
    &-mask {
      ...
      width: 100%;
      height: 100%;
      background: rgba($color: #3a3838, $alpha: 0.86);
      button {
        width: 140px;
        height: 44px;
        background: none;
